...
class BasicQGDHistgram
{
 public:
  ...
  TH1D *h_b_jetchargejetetabin[JETSETA_BINS], *h_b_jetchargejetetabin_ljets[JETSETA_BINS], *h_b_jetchargejetetabin_cjets[JETSETA_BINS], *h_b_jetchargejetetabin_bjets[JETSETA_BINS], *h_b_jetchargejetetabin_gjets[JETSETA_BINS], *h_b_jetchargejetetabin_pjets[JETSETA_BINS];
  ...
  TH2D *h_b_jetcharge_qglikelihood;
};
