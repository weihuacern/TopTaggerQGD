  ...
  {  
    ...
    while(tr.getNextEvent())
    {
      ...
      for(auto i=0;i<jetsLVec.size();i++)
      {
        ...
        (myEffHistgram.h_b_qgptd)->Fill(qgPtD.at(i),thisweight);
        (myEffHistgram.h_b_qgaxis2)->Fill(qgAxis2.at(i),thisweight);
        (myEffHistgram.h_b_qgmult)->Fill(qgMult.at(i),thisweight);
        
        if(std::abs(pdgid) >=1 && std::abs(pdgid) <= 5)
        { 
          (myEffHistgram.h_b_qglikelihood_qjets)->Fill(qgLikelihood.at(i),thisweight);
          (myEffHistgram.h_b_qgptd_qjets)->Fill(qgPtD.at(i),thisweight);
          (myEffHistgram.h_b_qgaxis2_qjets)->Fill(qgAxis2.at(i),thisweight);
          (myEffHistgram.h_b_qgmult_qjets)->Fill(qgMult.at(i),thisweight);
        }
        else if(pdgid == 21)
        { 
          (myEffHistgram.h_b_qglikelihood_gjets)->Fill(qgLikelihood.at(i),thisweight);
          (myEffHistgram.h_b_qgptd_gjets)->Fill(qgPtD.at(i),thisweight);
          (myEffHistgram.h_b_qgaxis2_gjets)->Fill(qgAxis2.at(i),thisweight);
          (myEffHistgram.h_b_qgmult_gjets)->Fill(qgMult.at(i),thisweight);
        }
        else if(pdgid == 0)
        { 
          (myEffHistgram.h_b_qglikelihood_pjets)->Fill(qgLikelihood.at(i),thisweight); 
          (myEffHistgram.h_b_qgptd_pjets)->Fill(qgPtD.at(i),thisweight);
          (myEffHistgram.h_b_qgaxis2_pjets)->Fill(qgAxis2.at(i),thisweight);
          (myEffHistgram.h_b_qgmult_pjets)->Fill(qgMult.at(i),thisweight);
        }
